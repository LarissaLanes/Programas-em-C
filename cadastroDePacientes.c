    ...
    do
	{
        ...
        switch(opcao){
            ...
            case 1:;
                ...
                int mesA = data_hora_atual->tm_mon+1; //mÍs
                ...
                if(ValidarSomenteTexto(nome)!=1){
                    printf("\nNome informado È inv·lido pois est· vazio ou contem n˙meros.");
                    getch();
                    goto final_1;
                }
                ...
                printf("\n(N„o digite 'exit' nessa informaÁ„o.')\n");
                ...
                printf("\nVocÍ tem algum comorbidade(Sim 1/Nao 2): ");
            ...
            case 2:;
                ...
                {   printInfoBase(0);
                    ...
                    printf("Por favor verifique as permissıes de acesso ou se os arquivos existem.\n");
                    exit(EXIT_FAILURE);
                } else do {
...
void printInfoBase(int informarOpcaoCancelar){
    ...
    printf("%d/",data_hora_atual->tm_mon+1); //mÍs
